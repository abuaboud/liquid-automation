...
public enum SkillCategory {
    ...
    COMBAT("Combat", new String[]{"Combat"}, "/resources/skills/Combat.png", new int[]{2}),
    ...
    FIREMAKING("Firemaking", new String[]{"Firemaking"}, "/resources/skills/Firemaking.png", new int[]{7}),
    FISHING("Fishing", new String[]{"Fishing"}, "/resources/skills/Fishing.png", new int[]{8}),
    ...
    MINING("Mining", new String[]{"Mining"}, "/resources/skills/Mining.png", new int[]{14}),
    MINI_GAMES("Mini-games", new String[]{"Mini-games"}, "/resources/skills/minigames.png", new int[]{15}),
    MONEY_MAKING("Money Making", new String[]{"Money Making"}, "/resources/skills/moneymaking.png", new int[]{16}),
    PRAYER("Prayer", new String[]{"Prayer"}, "/resources/skills/Prayer.png", new int[]{17}),
    RANGED("Ranged", new String[]{"Ranged"}, "/resources/skills/Ranged.png", new int[]{18}),
    RUNECRAFTING("Runecrafting", new String[]{"Runecrafting"}, "/resources/skills/Runecrafting.png", new int[]{19}),
